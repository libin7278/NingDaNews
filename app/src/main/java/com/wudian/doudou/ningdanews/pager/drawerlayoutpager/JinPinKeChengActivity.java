...
public class JinPinKeChengActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiao_wu_ping_tai);
        ...
        wv_ningdashouye.loadUrl("http://nxu.nx.nclass.org/sc8/page/schoolspace/academy-list.do");
