 ...
 */
public class MetableDebugView extends View {
    ...
    public MetableDebugView(Context context) {
        super(context);
        init();
    }

    public MetableDebugView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MetableDebugView(Context context, AttributeSet attrs, int defStyleAttr) {
